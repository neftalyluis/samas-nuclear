...
import mx.samas.ejb.mdb.QueueSenderSessionBean;
import mx.samas.ejb.mdb.WSJMSMessage;
...
public class Notifier implements Serializable{
    ...
    public void onOpen(final Session session) {
        try {
            ...
            if (senderBean == null) {
                Logger.getLogger(Notifier.class.getName()).log(Level.INFO, "senderBean is null");
            }
        } catch (Exception ex) {
    ...
    public void onJMSMessage(@Observes @WSJMSMessage Message msg) {
        Logger.getLogger(Notifier.class.getName()).log(Level.INFO, "Got JMS Message at WebSocket!");
