 ...
 */
@Entity
public class NewAssetValues<T> implements Serializable {
    ...
    @ManyToOne
    private NewAssetProperties property;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NewAssetValues)) {
            return false;
        }
        NewAssetValues other = (NewAssetValues) object;
     ...
     * @return the property
     */
    public NewAssetProperties getProperty() {
        return property;
    }
     ...
     */
    public void setProperty(NewAssetProperties property) {
