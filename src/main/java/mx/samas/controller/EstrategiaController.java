...
public class EstrategiaController {
    ...
    public ResponseEntity<List<Modelo>> getAllEstrategias() {
     ...
     * @return Si input se valida, tendremos como respuesta que se creo de manera exitosa la Modelo.
         De lo contrario, la respuesta nos informara de una mala request.
     */
    @RequestMapping(method = RequestMethod.POST)
    public ResponseEntity<Modelo> newEstrategia(EstrategiaDTO input) {
        if (input.validate()) {
     ...
     * @return Una respuesta de que se encontro con exito la Modelo por su Id. 
     */
