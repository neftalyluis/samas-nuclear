...
public class FuenteDatos implements Serializable {
    ...
    @OneToMany
    private List<TipoFuenteDatos> tipoFuente;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FuenteDatos)) {
            return false;
        }
        FuenteDatos other = (FuenteDatos) object;
    ...
    public String toString() {
        return "mx.samas.domain.FuenteDatos[ id=" + id + " ]";
    }
    ...
    /**
     * @param valorParametros the valorParametros to set
     */
